...
INSERT INTO departamento VALUES (null, "Alimentacao", "Proteinas e Suplementos");
INSERT INTO departamento VALUES (null, "Bedidas", "Vamos Comemorar");
INSERT INTO departamento VALUES (null, "Papelaria", "Canetas, Agendas e Post-it");
INSERT INTO departamento VALUES (null, "Bebe", "Fraldas, Mamadeiras e Acessórios");
...
INSERT INTO produto VALUES (null, "Protein Crisp Bar 12un","Protein Crisp Bar Cheesecake Frutas Vermelhas, IntegralMedica",72,4,"protein.jpg",5);
INSERT INTO produto VALUES (null, "Gin Tanqueray","Gin Tanqueray London Dry - 750ml",110,8,"gin.jpg",6);
INSERT INTO produto VALUES (null, "Bloco autoadesivo","Bloco autoadesivo Post-it 76x76 sortido c/450fls",43,5,"postit.jpg",7);
INSERT INTO produto VALUES (null, "Fralda Pampers","Fralda Pampers Confort Sec Tam. G 9 a 13kg",90,6,"fraldas.jpg",8);


-- tabela cliente

INSERT INTO cliente VALUES (null, "Jose Alberto Neves","josealberto@mail.com","123456","876123-99","987.654.321-00");
INSERT INTO cliente VALUES (null, "Antonio Oliveira","antoniooli@mail.com","987654","983256-72","765.432.987.10");
INSERT INTO cliente VALUES (null, "Regina Brito","reginabrito@mail.com","010203","235645-90","123.456.789-00");
INSERT INTO cliente VALUES (null, "Rafael Tenorio","rafaeltenorio@mail.com","123123","564579-20","369.452.637-28");
INSERT INTO cliente VALUES (null, "Bruno Galvao","brunogalvao@mail.com","234234","987451-25","278.562.814-56");
...
-- a mesma consulta renomeando o título da coluna: 
...
select codigo, nome, departamento_codigo from produto; 

  

-- renomeando as colunas para melhor vizualizacao 

select codigo as 'id', nome as 'nome do produto', departamento_codigo as 'codigo do departamento' from produto; 
